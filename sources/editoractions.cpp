...
void Editor::RefreshToolbarButtons(){
    ...
    ToolbarItems[0].push_back(make_shared<ToolbarButtonList>(vector<string>{"Paint", "Selection"},Vector2d(0.2*Resolution.x, 0.925*Resolution.y)
                                ,0.05*Resolution.x, &Editor::PaintSelectionAction, TrackTexture, textpos,0,&PaintSelection));
    ToolbarItems[1].push_back(make_shared<ToolbarButtonList>(vector<string>{"Paint", "Selection"},Vector2d(0.2*Resolution.x, 0.925*Resolution.y)
                                ,0.05*Resolution.x, &Editor::PaintSelectionAction, TrackTexture, textpos,0,&PaintSelection));
    ...
    ToolbarItems[1].push_back(make_shared<ToolbarButton>(vector<string>{"Edit Switches", "ON/OFF"},Vector2d(0.925*Resolution.x, 0.25*Resolution.y)
                                ...
                                , vector<Vector2u>{Vector2u(0,0),Vector2u(0,1)}, SwitchMode));
    ...
    ToolbarItems[1].push_back(make_shared<ToolbarButton>(vector<string>{"Paint Mode", "ON/OFF"},Vector2d(0.5*Resolution.x, 0.925*Resolution.y)
                                ,0.05*Resolution.x, &Editor::TrapPaintModeAction, ButtonTexture
                                , vector<Vector2u>{Vector2u(0,0),Vector2u(0,1)}, TrapPaintMode));
    ToolbarItems[1].push_back(make_shared<ToolbarButton>(vector<string>{"Wiring Mode", "ON/OFF"},Vector2d(0.65*Resolution.x, 0.925*Resolution.y)
                                ,0.05*Resolution.x, &Editor::WiringModeAction, ButtonTexture
                                , vector<Vector2u>{Vector2u(0,0),Vector2u(0,1)}, WiringMode));
...
void Editor::TrapPaintModeAction(unsigned &RenderIndex){
    TrapPaintMode=!TrapPaintMode;
    RenderIndex=TrapPaintMode;
    WiringMode=0;
    SwitchMode=0;
    RefreshToolbarButtons();
    RefreshTrackRendering();
