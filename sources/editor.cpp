...
void Editor::Update(double DeltaTime){
    ...
    unsigned maxX=Window->getSize().x;
    unsigned maxY=Window->getSize().y;
    if(LocalMousePosition.x>=0 && LocalMousePosition.x<maxX && LocalMousePosition.y>=0 && LocalMousePosition.y<maxY)
    {
